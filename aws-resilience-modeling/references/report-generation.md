...
**Method 1: Embedded Mode (Recommended)**
...
**Method 2: Standalone File Mode**
```markdown
Filename: {project-name}-chaos-input-{date}.md
Example: ecommerce-chaos-input-2026-02-28.md

Content: Generated according to the "Chaos Engineering Test Plan" specification structure,
including: project metadata, AWS resource inventory (with ARNs), business function dependency chains,
risk inventory (with experiment-readiness flags and suggested injection methods), risk details,
monitoring readiness, resilience scores (9 dimensions), constraints and preferences, open findings
```
...
└── {project-name}-chaos-input-{date}.md              (Chaos engineering data, standalone file mode, optional)
```
